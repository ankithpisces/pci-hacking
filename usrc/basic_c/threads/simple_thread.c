...
In main() we declare a variable tid, which is of type pthread_t, which is an integer used to identify the thread in the system. 
After declaring tid, we call pthread_create() function to create a thread.
